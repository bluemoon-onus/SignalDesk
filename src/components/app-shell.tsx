                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 px-4 pb-1 pt-2">
                          ...
                          <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-emerald-600">
                            {t("shell.generated_section")}
                          </span>
                          {adminMode && (
                            <span className="ml-auto rounded-full bg-amber-100 px-1.5 py-px text-[8px] font-semibold uppercase tracking-wider text-amber-700">
                              {t("shell.admin_mode")}
                            </span>
                          )}
                        </div>
                            ...
                            >
                              ...
                              {adminMode && (
                                <button
                                  ...
                                  title={t("shell.delete_account")}
                                  className="ml-2 shrink-0 rounded-lg p-1 text-slate-400 transition-colors hover:bg-rose-50 hover:text-rose-500"
                                >
