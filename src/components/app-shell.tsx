...
// ─── Industry groups for the dropdown ────────────────────────────────────────
const industryOrder = [
  "Semiconductor",
...
function buildGroups() {
  ...
  // Catch any industry not in the ordered list
...
const navSections = [
  ...
  { key: "pilot",         label: "Pilot & ROI",   description: "Scope, ROI, and the follow-up email",    icon: BriefcaseBusiness },
] as const;
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs leading-5 text-slate-500">
                  From first signal to signed pilot — built for enterprise AI sales.
                </p>
              </div>
            </div>
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="font-mono text-[9px] uppercase tracking-[0.22em] text-slate-500">Active account</div>
                ...
                <ChevronDown
                  className={cn("ml-2 h-3.5 w-3.5 shrink-0 text-slate-400 transition-transform duration-200", switcherOpen && "rotate-180")}
                />
              </button>
                        ...
                        <div key={industry}>
                          ...
                          {accounts.map((acct) => (
                            ...
                            >
                              <span className={cn(
                                "font-medium",
                                acct.id === accountId ? "text-slate-950" : "text-slate-700"
                              )}>
                                {acct.company}
                              </span>
                              {acct.id === accountId && (
          ...
          <Card className="border-white/70 bg-white/80 shadow-panel">
            <div className="flex flex-col gap-3 px-5 py-4 md:flex-row md:items-center md:justify-between">
              <div className="space-y-1">
                <p className="font-mono text-[10px] uppercase tracking-[0.24em] text-slate-400">Account focus</p>
              ...
              <div className="flex items-center gap-2 rounded-xl border border-emerald-200/80 bg-emerald-50/60 px-4 py-2.5">
                ...
                <span className="text-xs text-emerald-600">year-1 value</span>
              </div>
            </div>
          </Card>
